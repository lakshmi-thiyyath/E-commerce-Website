...
export function renderPaymentSummary(){
    ...
    cart.forEach((cartItem) => {
        ...
        productPriceCents += product.priceCents * cartItem.quandity;
        ...
        cart.forEach((cartItem) =>{
         ...
         const paymentSummmaryHtml = `
                    ...
                    <div class="payment-summary-row subtotal-row">
                        ...
                        <div class="payment-summary-money total-tax">$${formatCurrency(totalBeforeTax)}</div>
                    </div>
